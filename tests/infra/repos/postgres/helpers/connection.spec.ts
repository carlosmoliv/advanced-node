...
describe('PgConnection', () => {
  ...
  it('should return ConnectionNotFoundError on disconnect if connection is not found', async () => {
    ...
    await expect(promise).rejects.toThrowError(new ConnectionNotFoundError())
  })
  ...
  it('should return TransactionNotFoundError on rollbackTransaction if query runner is not found', async () => {
