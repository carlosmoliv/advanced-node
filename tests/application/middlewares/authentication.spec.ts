...
describe('AuthenticationMiddleware', () => {
  ...
  it('should return 403 if auhtorization is empty', async () => {
  ...
  it('should return 403 if auhtorization is null', async () => {
  ...
  it('should return 403 if auhtorization is undefined', async () => {
